...
export default function ScienceOfPunchingPowerPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-[800px] mx-auto px-4 py-8 md:py-14">
        ...
        <div className="prose-oracle space-y-6 text-[#37322F] text-[17px] leading-[1.75]">
          ...
          <p>
            <strong>Hips creeping forward:</strong> As you rotate, your hips should stay hinged. If they extend forward during the punch, you lose all structural support. The fix: think about pushing your hips backwards even as you rotate through.
          </p>
          <p>
            <strong>Tension in the shoulders:</strong> Tense shoulders block the stretch-shortening cycle. Your shoulders should be relaxed and rounded forward in your shape. If they&apos;re raised up or locked tight, the whip effect dies at the torso and never reaches the fist.
          </p>
          <p>
            <strong>Arm leading the rotation:</strong> If your arm extends before your hips and torso have rotated, you&apos;re arm-punching. The arm is always last. Practice the rotation with your hands at your sides first - let your arms swing naturally like dead weight as your body rotates. That loose, whipping motion is exactly what you want in your punches.
          </p>
          <p>
            <strong>Feet leaving the ground:</strong> Some beginners push off so hard they lift their feet, lunging into punches. You lose your base, your balance, and your ability to follow up or defend. Your feet stay planted. The power comes from rotation through the ground, not from launching yourself forward.
          </p>
          ...
          <div className="mt-14 py-10 px-6 md:px-10 bg-[#37322F]/[0.03] rounded-2xl text-center">
            ...
            <p className="text-[#605A57] mb-6 max-w-[500px] mx-auto">
              The 21-Day Boxing Challenge teaches you the rotation, shape, and body mechanics that generate real punching power - with personalised coaching feedback at every step.
            </p>
            <Link
              href="/checkout-v2"
